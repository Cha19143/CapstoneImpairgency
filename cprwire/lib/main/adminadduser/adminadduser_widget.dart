...
import 'adminadduser_model.dart';
export 'adminadduser_model.dart';
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          FlutterFlowDropDown<String>(
                            ...
                            options:
                                List<String>.from(['BLIND', 'VISION LOSS']),
                            optionLabels: ['BLIND', 'LOW VISION'],
                            onChanged: (val) =>
                            ...
                            hintText: 'Type of Visual Impairment',
                            icon: Icon(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                await FirebaseFirestore.instance.collection('users').add({
                                 ...
                                 'visionType': _model.dropDownValue,
                                 'emergencyContactName': _model.textController3.text.trim(),
                                 'emergencyContactNumber': _model.textController4.text.trim(),
                                 'role': 'user',
                                 'status': 'active',
